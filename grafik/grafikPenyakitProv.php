...
<body>
	...
	<!--Navbar-->
             <nav class="navbar fixed-top navbar-expand-lg" style="background-color: #e3f2fd;">
                  ...
                  <ul class="navbar-nav mr-auto">
                    ...
                    <?php if($_SESSION["id_pasien"]!="" || $_SESSION["id_admin"]!=""){
                        echo "<li class='nav-item'>";
                        echo "<a class='nav-link' href='grafikPenyakitProv.php'>Infografi</a>";
                        echo "</li>";
                    }
                    ?>
                    <?php if(isset($_SESSION["id_pasien"])){
	...
	<form action="" method="GET" class="form-inline my-2 my-lg-0">
            			    ...
            			    <label>Penyakit &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :</label>	
								<select name="penyakit" class="custom-select" id="inputGroupSelect04">
									<option>
	...
	<form action="grafikPenyakitKota.php" method="GET" class="form-inline my-2 my-lg-0">
							<div class="input-group">
						...
						<div class="input-group-append">	
						<button class="btn btn-outline-secondary"  type="submit">Pilih</button></div>
					</div>
					</form>
<br>

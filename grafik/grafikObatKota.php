...
<a href="grafikObatProv.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true" style="background-color: #DC143C ; border-color: #DC143C; font-size: 11pt; " autocomplete="on">Kembali</a><br>
		...
		var myChart = new Chart(ctx, {
			<?php 
				...
				foreach ($result as $prov) {
					$id =$prov["id_kota"];
					$hitung = mysqli_query($conn, "SELECT * FROM rekap_medis WHERE jenis_obat = '$obat' AND id_pasien IN(SELECT id_pasien FROM pasien WHERE id_kota = $id)");
